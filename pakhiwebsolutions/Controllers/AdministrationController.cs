...
{
    //[Authorize(Policy = "AdminiRolePolicy")]
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> CreateRole(CreateRoleViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //Saves the role in the underlying AspNetRoles tables
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            foreach (var user in userManager.Users)
            {
                ...
                //This mode object is then passed to view for display.
        ...
        //This action responds to HttpPost and recives EditRoleViewModel
        [HttpPost]
        [Authorize(Policy = "EditRolePolicy")]
        ...
        public async Task<IActionResult> ManageUserClaims(string userId)
        {
            ...
            //UserManager service Get ClaimsAsync method gets all the current claims of the user
            ...
            foreach (Claim claim in ClaimsStore.AllClaims)
            {
                ...
                //If the suer has the claim, set IsSelected property to true, so the checkbox next to the claim is checked on the UI
